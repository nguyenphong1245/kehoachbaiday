...
**Hoạt động:** Cô phững loại cáp mạng nào?
...
- **Hình 23.2.** Cặp xoắn không bọc (Unshielded Twisted Pair UTP)
...
### Bảng 23.1: Tiêu chuẩn truyền thông trong mạng Ethernet
| Loại cáp  | Băng thông (Mbps) | Khoảng cách tối đa (m) |
|-----------|--------------------|------------------------|
| CAT.4     | 100                | 100                    |
| CAT.5     | 100                | 100                    |
| CAT.6     | 1000               | 100                    |
...
### Bài tập và câu hỏi
1. Nêu các loại cáp truyền tín hiệu trong mạng máy tính.
2. Giải thích tại sao cáp xoắn lại được sử dụng phổ biến trong mạng cục bộ.
3. So sánh băng thông và khoảng cách tối đa của các loại cáp trong Bảng 23.1.



# Bài học: Các chuẩn truyền thông trong mạng Ethernet

## Nội dung lý thuyết
Tốc độ truyền thông thường được đo bằng Megabit/s (Mbit/s) hay Gigabit/s (Gbit/s). Dưới đây là bảng các chuẩn truyền thông trong mạng Ethernet:
...
| 1000BASE-LX    | Cáp quang đơn mode| 1 Gbit/s    | 550 m (cáp đa mode)        |                      |
|                |                   |             | 5000 m (cáp đơn mode)     |                      |
| 1000BASE-CX    | Cáp xoắn bọc kim STP | 1-10 Gbit/s | 25 m                       |                      |
| 1000BASE-T     | Cáp xoắn CAT 6    | 1-10 Gbit/s | 100 m (CAT5, CAT6)        |                      |

### Cáp quang
Với cáp xoắn, khoảng cách truyền hiệu quả chỉ khoảng 100 m. Nếu cần mở rộng mạng, người ta có thể dùng các thiết bị chuyển tiếp dữ liệu như repeater hay switch để kéo dài thêm đường truyền; tuy nhiên có những hạn chế kỹ thuật về số lần chuyển tiếp.
...
## Bài tập và câu hỏi
1. Giải thích sự khác nhau giữa cáp quang đa mode và cáp quang đơn mode.
2. Tại sao cáp quang lại có thể truyền tín hiệu xa hơn so với cáp đồng?
3. Nêu các ưu điểm của cáp quang so với cáp đồng.



# Bài học: Đường truyền dữ liệu
...
| Loại cáp       | Tốc độ truyền | Khoảng cách truyền | Chi phí         |
|----------------|---------------|--------------------|------------------|
| Cáp đồng       | Thấp          | Ngắn               | Thấp             |
| Cáp quang      | Cao           | Dài                | Cao              |

----

# Bài học: Đường truyền không dây
...
# Hệ thống định vị toàn cầu và Mạng thông tin di động
...
Vệ tinh đã được sử dụng để kết nối Internet. Dự án Starlink dùng hàng nghìn vệ tinh quỹ đạo thấp kết nối Internet qua các trạm thu trên mặt đất đã trở thành hiện thực. Starlink mang lại cơ hội sử dụng Internet cho những nơi chưa có điều kiện thi công cáp như ở sa mạc, rừng sâu, đỉnh núi cao, với chi phí thấp.

### 2. Mạng thông tin di động toàn cầu GSM
...
- Chuẩn 802.11b có tốc độ 11 Mbps.
- Chuẩn 802.11a và 802.11g có tốc độ 54 Mbps.
- Chuẩn 802.11n có tốc độ 450 Mbps.

## Ví dụ minh họa
- Hình 23.6: Các trạm BTS

## Bài tập và câu hỏi
1. Giải thích vai trò của hệ thống định vị toàn cầu trong đời sống hiện đại.
2. So sánh các thế hệ mạng GSM và nêu rõ sự khác biệt giữa chúng.
3. Trình bày các chuẩn Wi-Fi và tốc độ truyền dữ liệu của từng chuẩn.

## Hình ảnh mô tả
- Hình 23.6: Các trạm BTS (Ghi chú: Hình ảnh mô tả các trạm thu phát sóng di động trong mạng GSM).

## Bảng biểu
| Chuẩn Wi-Fi      | Tốc độ truyền dữ liệu |
|------------------|-----------------------|
| 802.11b          | 11 Mbps               |
| 802.11a          | 54 Mbps               |
| 802.11g          | 54 Mbps               |
...
# Bài học: Kết nối không dây

## Nội dung lý thuyết

### 1. Chuẩn Wi-Fi
- **Chuẩn 802.11ac**: Tốc độ tối đa đạt đến 1,3 Gbps.
- **Chuẩn 802.11ad**: Sử dụng dải tần 60 GHz, có thể cho tốc độ tối đa tới 4,6 Gbps.
- Khi thiết kế mạng có Wi-Fi, cần tính đến chuẩn nào sẽ được sử dụng.

### 2. Bluetooth
- Bluetooth là một loại hình mạng có tốc độ khoảng 1 Mbps trong một phạm vi bán kính khoảng 10 m; rất thích hợp để kết nối các thiết bị cá nhân và đồ gia dụng.
- Bluetooth thường chỉ kết nối hai thiết bị với nhau.
- Bluetooth tiện lợi hơn rất nhiều so với cách kết nối qua cáp.

### 3. Ứng dụng của Bluetooth
- Kết nối máy tính hay điện thoại di động với loa nghe không dây.
...
### 4. Kết nối không dây
- Truyền dữ liệu không dây rất tiện lợi và rất phổ biến; như trong các mạng vệ tinh, mạng thông tin di động, mạng Wi-Fi, Bluetooth hoặc NFC.
- Cần hiểu rõ tính năng và môi trường làm việc của các kết nối không dây để sử dụng cho thích hợp.

## Ví dụ minh họa
- Kết nối điện thoại với loa Bluetooth để nghe nhạc.
- Sử dụng Bluetooth để truyền ảnh từ điện thoại sang máy tính.
...
2. Wi-Fi và Bluetooth đều là các giao tiếp không dây trong một phạm vi nhỏ. Chúng có thay thế được nhau không? Tại sao? (Gợi ý: Xem xét những trường hợp ứng dụng thích hợp với mỗi loại giao tiếp).
...
## Hình ảnh mô tả
- (Ghi chú về hình ảnh: Hình ảnh minh họa các thiết bị kết nối Bluetooth, mạng Wi-Fi và các ứng dụng của NFC).

## Bảng biểu
- (Ghi chú về bảng biểu: Bảng so sánh các loại kết nối không dây như Wi-Fi, Bluetooth, NFC về tốc độ, phạm vi, ứng dụng).